...
CRAMER is distributed in the hope that it will be useful, 
but WITHOUT ANY WARRANTY; without even the implied warranty of 
MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  
See the GNU General Public License for more details. You should have 
received a copy of the GNU General Public License along with CRAMER; 
...
Suite 330, Boston, MA  02111-1307  USA"""
    ...
    def onSettParams(self, event):
        ...
        panel = wx.Panel(parent=frame, id=-1, style=wx.TAB_TRAVERSAL|wx.BORDER, name='Simulation Setup Panel')
        ...
        h_sizer1.Add(wx.StaticText(frame, label="", style=wx.TE_READONLY), proportion=1)
        h_sizer2.Add(wx.StaticText(frame, label="", style=wx.TE_READONLY), proportion=1)
        ...
        h_sizer1.Add(wx.StaticText(frame, label="Model: ", style=wx.TE_READONLY), proportion=1)
        model = wx.ComboBox(parent=frame, choices = contactModels)
        h_sizer1.Add(model, proportion=2)

        h_sizer1.Add(wx.StaticText(frame, label="", style=wx.TE_READONLY), proportion=1)
        h_sizer1.Add(wx.StaticText(frame, label="Boundaries: ", style=wx.TE_READONLY), proportion=1)
        boundaries = wx.TextCtrl(frame)
        h_sizer1.Add(boundaries, proportion=2)

        h_sizer1.Add(wx.StaticText(frame, label="", style=wx.TE_READONLY), proportion=1)
        h_sizer1.Add(wx.StaticText(frame, label="Box Size: ", style=wx.TE_READONLY), proportion=1)
        simBox = wx.TextCtrl(frame)
        h_sizer1.Add(simBox, proportion=2)

        h_sizer1.Add(wx.StaticText(frame, label="", style=wx.TE_READONLY), proportion=1)

        h_sizer2.Add(wx.StaticText(frame, label="Ext. Force: ", style=wx.TE_READONLY), proportion=1)
        force = wx.TextCtrl(frame)
        h_sizer2.Add(force, proportion=2)

        h_sizer2.Add(wx.StaticText(frame, label="", style=wx.TE_READONLY), proportion=1)
        h_sizer2.Add(wx.StaticText(frame, label="Timestep: ", style=wx.TE_READONLY), proportion=1)
        timeStep = wx.TextCtrl(frame)
        h_sizer2.Add(timeStep, proportion=2)

        h_sizer2.Add(wx.StaticText(frame, label="", style=wx.TE_READONLY), proportion=1)
        unitSys = ['SI', 'Metal', 'LJ']
        h_sizer2.Add(wx.StaticText(frame, label="Units: ", style=wx.TE_READONLY), proportion=1)
        model = wx.ComboBox(parent=frame, choices = unitSys)
        h_sizer2.Add(model, proportion=2)
        h_sizer2.Add(wx.StaticText(frame, label="", style=wx.TE_READONLY), proportion=1)

        h_sizer3.Add(wx.StaticText(frame, label="", style=wx.TE_READONLY), proportion=1)
        h_sizer3.Add(wx.StaticText(frame, label="Newton 3rd Law: ", style=wx.TE_READONLY), proportion=1)
        ...
        h_sizer3.Add(wx.StaticText(frame, label="Cohesion: ", style=wx.TE_READONLY), proportion=1)
        ...
        h_sizer3.Add(wx.StaticText(frame, label="Rolling: ", style=wx.TE_READONLY), proportion=1)
        ...
        h_sizer3.Add(wx.StaticText(frame, label="Tangential: ", style=wx.TE_READONLY), proportion=1)
        ...
        h_sizer4.Add(wx.StaticText(frame, label="", style=wx.TE_READONLY), proportion=1)
