    ...
    def onAddSS(self, event):
        ...
        if not self.component_frame:
            ...
            self.component_frame = wx.Frame(
                ...
                size=(self._WIDTH * 1.6, self._LENGTH * 0.6),
            )
            frame = self.component_frame
            addEmptySpace = lambda sizer: "h_sizer{}.Add(wx.StaticText(frame, label='', style=wx.TE_READONLY), proportion=1)".format(
                sizer
            )
            ...
            resetBtn = wx.Button(
                parent=frame, id=wx.ID_ANY, label="Cancel", size=(80, 40)
            )

            materials = ["Glass"]
            eval(addEmptySpace(1))
            h_sizer1.Add(
                wx.StaticText(frame, label="Materials: ", style=wx.TE_READONLY),
                proportion=2,
            )
            eval(addEmptySpace(1))
            ...
            eval(addEmptySpace(1))
            h_sizer1.Add(
                wx.StaticText(frame, label="Id: ", style=wx.TE_READONLY), proportion=2
            )
            eval(addEmptySpace(1))
            ...
            eval(addEmptySpace(1))
            h_sizer1.Add(
                wx.StaticText(frame, label="# Particles: ", style=wx.TE_READONLY),
                proportion=2,
            )
            eval(addEmptySpace(1))
            ...
            h_sizer2.Add(
                wx.StaticText(frame, label="Radius: ", style=wx.TE_READONLY),
                proportion=1,
            )
            # eval(addEmptySpace(2))
            ...
            v_sizer.Add(
                wx.StaticText(frame, label="", style=wx.TE_READONLY), proportion=1
            )
        ...
        if not self.settings_frame:
            ...
            def settToolBar(frame):
                ...
                loadBtn = ToolBar.AddLabelTool(
                    wx.ID_ANY, "&Trajectory", wx.Bitmap(self.iconsDir + "Settings.png")
                )
                ToolBar.AddSeparator()

                addSSBtn = ToolBar.AddLabelTool(
                    wx.ID_ANY, "Add &Subsystem", wx.Bitmap(self.iconsDir + "AddSS.png")
                )
                ToolBar.AddSeparator()

                addWall = ToolBar.AddLabelTool(
                    wx.ID_ANY, "Add &Wall", wx.Bitmap(self.iconsDir + "AddWall.png")
                )
            ...
            self.settings_frame = wx.Frame(
                parent=self,
                id=-1,
                name="Simulation Setup",
                size=(self._WIDTH * 1.6, self._LENGTH * 1.1),
            )
            ...
            resetBtn = wx.Button(
                parent=frame, id=wx.ID_ANY, label="Reset", size=(80, 40)
            )

            contactModels = ["Spring Dashpot", "Hertz Mindlin", "Hysteresis Thorn"]
            eval(addEmptySpace(1))
            h_sizer1.Add(
                wx.StaticText(frame, label="Model: ", style=wx.TE_READONLY),
                proportion=2,
            )
            eval(addEmptySpace(1))
            ...
            shapes = ["Spherical"]
            h_sizer1.Add(
                wx.StaticText(frame, label="Shape: ", style=wx.TE_READONLY),
                proportion=2,
            )
            eval(addEmptySpace(1))
            ...
            eval(addEmptySpace(1))
            h_sizer1.Add(
                wx.StaticText(frame, label="Box Size: ", style=wx.TE_READONLY),
                proportion=2,
            )
            eval(addEmptySpace(1))
            simBox = wx.TextCtrl(frame)
            ...
            eval(addEmptySpace(2))
            h_sizer2.Add(
                wx.StaticText(frame, label="Ext. Force: ", style=wx.TE_READONLY),
                proportion=2,
            )
            eval(addEmptySpace(2))
            ...
            eval(addEmptySpace(2))
            h_sizer2.Add(
                wx.StaticText(frame, label="Timestep: ", style=wx.TE_READONLY),
                proportion=2,
            )
            eval(addEmptySpace(2))
            ...
            unitSys = ["SI", "Metal", "LJ"]
            h_sizer2.Add(
                wx.StaticText(frame, label="Units: ", style=wx.TE_READONLY),
                proportion=2,
            )
            eval(addEmptySpace(2))
            ...
            eval(addEmptySpace(3))
            h_sizer3.Add(
                wx.StaticText(frame, label="Newton 3rd Law: ", style=wx.TE_READONLY),
                proportion=2,
            )
            eval(addEmptySpace(3))
            ...
            eval(addEmptySpace(3))
            h_sizer3.Add(
                wx.StaticText(frame, label="Cohesion: ", style=wx.TE_READONLY),
                proportion=2,
            )
            eval(addEmptySpace(3))
            ...
            eval(addEmptySpace(3))
            h_sizer3.Add(
                wx.StaticText(frame, label="Rolling: ", style=wx.TE_READONLY),
                proportion=2,
            )
            eval(addEmptySpace(3))
            ...
            eval(addEmptySpace(3))
            h_sizer3.Add(
                wx.StaticText(frame, label="Tangential: ", style=wx.TE_READONLY),
                proportion=2,
            )
            eval(addEmptySpace(3))
            ...
            h_sizer4.Add(
                wx.StaticText(frame, label="Boundaries: ", style=wx.TE_READONLY),
                proportion=2,
            )
            # eval(addEmptySpace(4))
